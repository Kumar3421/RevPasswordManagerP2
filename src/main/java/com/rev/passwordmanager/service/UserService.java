...
public class UserService {
    ...
    public ApiResponse<?> loginUser(LoginRequest request) {
        ...
        try {
            ...
            // Failsafe in case a non-bcrypt hashed password exists in DB
            return new ApiResponse<>(false, "Invalid password encoding in database. Please contact support or reset.", null);
        }
